...
#include <g3dhax.hpp>
#include <nw4r.hpp> // nw4r used to be here...
...
// NSMBWer# EXCLUSIVE (although the value is shared with NSMBWer+)
#define SAVE_BIT_NSMBWERSHARP 0x80
...
public:
	...
	virtual void setDeathInfo_IceBreak(); // deletes actors held by Class484 and other stuff
	virtual void setDeathInfo_IceVanish(); // deletes actors held by Class484 and makes an En Coin Jum
...
extern "C" nw4r::snd::SoundHandle *PlaySound(dStageActor_c *, u32 soundID);
...
extern "C" void* AllocFromGameHeap1(unsigned int size);
extern "C" void FreeFromGameHeap1(void* freed);

class dRes_c {
    // All I know at the moment is the sizes of these.
    u8 Resources[13];
    u8 ResourceProcessor[4];
};

class dResMng_c {
public:
    int setRes(const char* path, const char** loadArray, int length, void* heap); // heap is actually a EGG::Heap as you may have thought (0x800df8c0)
    dRes_c res;
