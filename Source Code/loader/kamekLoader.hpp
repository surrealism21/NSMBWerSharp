...
typedef int (*DVDConvertPathToEntrynum_t) (char *path);
...
typedef void (*CXUncompressLZ) (void* source, void* dest);
typedef u32 (*CXGetUncompressedSize) (void* sourceBuf);
...
struct loaderFunctions {
	...
	CXUncompressLZ CXUncompressLZ;
	CXGetUncompressedSize CXGetUncompressedSize;
};
