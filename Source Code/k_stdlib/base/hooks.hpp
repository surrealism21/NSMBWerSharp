...
// nop it conditionally.
#define kmCondWriteNop(addr, original, value) kmHook4(kctConditionalWrite, 2, (addr), (0x60000000), (original))
...
// nops a instruction, as nop is 0x60000000.
#define kmWriteNop(addr) kmHook3(kctWrite, 2, (addr), (0x60000000))
#define kmWriteBlr(addr) kmHook3(kctWrite, 2, (addr), (0x4e800020))
