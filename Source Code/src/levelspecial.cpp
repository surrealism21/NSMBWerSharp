...
//bool ResetAfterLevel(); // never actually called
...
kmWritePointer(0x803259FC, &MarioStateChanger);

kmBranchDefCpp(0x809259E0, NULL, bool, bool didItWork) {
...
kmBranchDefCpp(0x80926200, NULL, void, void) {
//void FuckinBubbles() {
...
int LevelSpecial::onExecute() {
	...
	if (newEvState == ACTIVATE)
	{
		...
		switch (this->type) {
			...
			case 9: // BG scale (not in Reggie yet)
				BGScaleEnabled = true;
			...
			// unused mario scale option is case 10
