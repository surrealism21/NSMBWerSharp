...
const SpriteData ChestnutSpriteData = {ProfileId::EN_CHESTNUT, 8, 0xFFFFFFF0, 0, 0, 0x100, 0x100, 0, 0, 0, 0, 0x10};
...
void daEnChestnut_c::yoshiCollision(ActivePhysics *apThis, ActivePhysics *apOther) {
