...
////////////////////////
	...
	// Let's help the shyguy not die at inappropriate times and ruin the dinner
	...
	void daShyGuy::setDeathInfo_IceBreak() {
		dEn_c::setDeathInfo_IceBreak();
		doStateChange(&StateID_Die);
	}
	void daShyGuy::setDeathInfo_IceVanish() {
...
int daShyGuy::onCreate() {
	...
	if (type == 6 || type == 7 || type == 8) {
		...
		iballoonPhysics.bitfield2  = 0xFFBA7FFE;
