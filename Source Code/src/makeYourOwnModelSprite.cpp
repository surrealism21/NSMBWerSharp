...
class dRYOMRes_c : public dActor_c {
public:
...
Profile RYOMRes5Profile(&dRYOMRes_c::build, SpriteId::EN_RYOM_RES_5, &RYOMRes5SpriteData, ProfileId::EN_RYOM_RES_5, ProfileId::EN_RYOM_RES_5, "EN_RYOM_RES_5", RYOMRes5ArcNameList);
