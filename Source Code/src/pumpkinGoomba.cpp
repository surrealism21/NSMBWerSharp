...
////////////////////////
	...
	void dGoombaPie::yoshiCollision(ActivePhysics *apThis, ActivePhysics *apOther) {
		this->playerCollision(apThis, apOther);
	}

	bool dGoombaPie::collisionCatD_Drill(ActivePhysics *apThis, ActivePhysics *apOther) {
		doStateChange(&StateID_Burst); return true;
	}
	...
	bool dGoombaPie::collisionCat14_YoshiFire(ActivePhysics *apThis, ActivePhysics *apOther){
		doStateChange(&StateID_DieSmoke); return true;
	}
	...
	void dGoombaPie::setDeathInfo_IceBreak() {
		dEn_c::setDeathInfo_IceBreak();
		doStateChange(&StateID_Burst);
	}
	void dGoombaPie::setDeathInfo_IceVanish() {
